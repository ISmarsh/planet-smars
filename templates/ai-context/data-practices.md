...
Detailed workflows for batch operations, data validation, and external data
sourcing. For core principles, see [AGENTS.md](AGENTS.md).
...
manual content review checklist from AGENTS.md ("Pre-commit verification"), plus:
